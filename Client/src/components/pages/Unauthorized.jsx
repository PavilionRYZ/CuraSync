...
import { Lock, ArrowLeft, Home, Phone } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                ...
                >
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-2xl">
                    ...
                    <motion.div variants={itemVariants}>
                        <h1 className="text-8xl font-heading font-bold bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent mb-2">
                            403
                        </h1>
                    ...
                    <motion.div variants={itemVariants} className="space-y-3">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500">
                            This page is restricted to authorized users only. If you believe you should have access, please contact support.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <a
                            ...
                            className="inline-flex items-center space-x-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 font-semibold transition-colors"
                        >
                            <Phone className="w-4 h-4" />
                            <span>support@curasync.com</span>
                        </a>
                    </motion.div>
                </motion.div>
            </div>
