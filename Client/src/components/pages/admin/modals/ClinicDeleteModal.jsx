...
const ClinicDeleteModal = ({ clinic, isOpen, onClose, onSuccess }) => {
    const { handleDeleteClinic, isLoading, error } = useClinic();
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await handleDeleteClinic(clinic._id);
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        <p className="text-sm text-red-800 dark:text-red-300 mb-3">
                            You are about to <strong>deactivate</strong> the following clinic:
                        </p>
                        <div className="mt-2 p-3 bg-white dark:bg-gray-700 rounded border border-red-200 dark:border-red-700">
